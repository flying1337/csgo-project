...
#ifndef uc-sflying-cm-_UTLMEMORY_H
#define uc-sflying-cm-_UTLMEMORY_H
...
#define MemAlloc_CrtCheckMemory() ((void)0)
#define MemAlloc_GlobalMemoryStatus( _usedMemory, _freeMemory ) ((void)0)
#define MemAlloc_MemoryAllocFailed() ((void)0)

#define MemAlloc_GetDebugInfoSize() ((void)0)
...
#define MemAlloc_GetSize( x ) ((void)0)
...
#else
        return (m_pMemory) ? csgo_memory_get_size(m_pMemory) : 0;
#endif
    }
...
#endif //uc-sflying-cm-_UTLMEMORY_H
