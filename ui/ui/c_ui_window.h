...
#ifndef uc-sflying-MENU_C_UI_WINDOW_H
#define uc-sflying-MENU_C_UI_WINDOW_H
...
public:
    ...
    c_ui_element* find(const std::string& name, const std::string& group);
...
#endif //uc-sflying-MENU_C_UI_WINDOW_H
